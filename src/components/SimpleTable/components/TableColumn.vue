...
import { ColumnProps, RenderScope, HeaderRenderScope } from '@/components/SimpleTable/interface'
import { filterEnum, formatValue, handleProp, handleRowAccordingToProp } from '@/utils/validate'
